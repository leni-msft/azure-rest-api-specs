...
`
        ...
        content = content.replace(/## AzureResourceSchema[\S\s]*\.\/readme.azureresourceschema.md\)/g, '')
        ...
        if (!!schemaReadmeContent) {
          const schemaReadme = path.join(f.dir, "readme.azureresourceschema.md");
          console.log(`deleting ${schemaReadme}`)
          await fs.unlink(schemaReadme);
        }
